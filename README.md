...
**Репозиторий проекта:** _вставьте ссылку после push_  
**Демо:** _вставьте ссылку после деплоя_
...
- **Почта:** `SMTP_*`, `OWNER_EMAIL` — Яндекс.Почта, пароль приложения
...
| Почта | Nodemailer, SMTP (Яндекс.Почта) |
...
- Отправка двух писем через SMTP:
